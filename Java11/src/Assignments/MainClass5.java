...
public class MainClass5
{
	...
	static int result = 0;
		...
		public static int call(int value)
		{
			...
			System.out.println("Do you enter price for one more value ? (yes/no)");
		...
		{
			FileOutputStream fout = new FileOutputStream("D:\\Java11\\data.txt");
		...
		public static int get() throws IOException
		{
			...
			FileInputStream fin = new FileInputStream ("D:\\Java11\\data.txt");
